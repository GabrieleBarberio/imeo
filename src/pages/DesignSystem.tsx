...
export const DesignSystem = () => {
  ...
  return (
    <>
      {/*main div*/}
      <div className="v-screen bg-blacky-100 flex flex-col">
        <div className="flex flex-col">
          <img src={logoType} className="w-60 mx-auto" alt="" />
          <h1 className="font-title font-bold text-3xl  text-white mx-auto my-2">
            IMEO - DESIGN SYSTEM
          </h1>
        </div>
        {/*main column div*/}
        <div className="flex flex-col gap-10">
          ...
          <div className="flex gap-10 justify-center">
            ...
            <div className="flex flex-col gap-10">
              ...
              <div className="flex flex-col bg-blacky-200 p-5 rounded-2xl">
                ...
                <div className="flex gap-2 p-1 font-title">
                  <span className=" text-white">Title</span>
                  <span className=" text-white font-bold">TITLE</span>
                  <span className=" text-white italic">title</span>
                </div>
                <div className="flex gap-2 p-1 font-paragraph">
                  <span className=" text-white">Paragraph</span>
                  <span className=" text-white font-bold">Paragraph</span>
                  <span className=" text-white italic">Paragraph</span>
                </div>
                <div className="flex gap-2 p-1 font-handwrite">
                  <span className=" text-white">This is Hand</span>
                  <span className=" text-white font-bold">This is Hand</span>
              ...
              <div className="flex flex-col bg-primary-200 p-5 rounded-2xl">
                ...
                <div className=" grid grid-cols-6 ">
                  ...
                  <div className="w-20 h-20 text-white bg-blacky-200 ">
                    <span>Blacky 200</span>
                  </div>
                  <div className="w-20 h-20 text-blacky-100 bg-white ">
                    <span>White</span>
                  </div>
                  <div className="w-20 h-20 text-white bg-primary-100 ">
                    <span>Primary 100</span>
                  </div>
                  <div className="w-20 h-20 text-white bg-primary-200 ">
                    <span>Primary 200</span>
                  </div>
                  <div className="w-20 h-20 text-white bg-primary-300 ">
                    <span>Primary 300</span>
                  </div>
                  <div className="w-20 h-20 text-white bg-primary-400 ">
                  ...
                  <div className="w-20 h-20 text-white bg-secondary-300 ">
                    <span>Secondary 300</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col w-6/12 gap-10">
              ...
              <div className="flex flex-col bg-primary-200 px-5 py-2 rounded-2xl ">
                ...
                <div className="flex justify-around items-center">
                  <div className="flex flex-col justify-between items-center text-white font-bold">
                    <div className="w-[120px] h-[120px] justify-center items-center">
                      <img
                        src={mascotte}
                        className="max-w-[80px] mx-auto my-auto "
                        alt=""
                      />
                    </div>
                    <span>Mascotte Logo</span>
                  </div>
                  <div className="flex flex-col justify-between items-center text-white font-bold">
                    <img
                      src={logoText}
              ...
              <div className="flex flex-col bg-blacky-200 text-white p-5 rounded-xl ">
                <div>
                  <span className="text-white font-bold text-2xl">Icons</span>
                </div>
                    ...
                    <i>
                      ...
                      >
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M5.20854 18.0419C6.30251 16.9479 7.78624 16.3333 9.33333 16.3333H18.6667C20.2138 16.3333 21.6975 16.9479 22.7915 18.0419C23.8854 19.1358 24.5 20.6195 24.5 22.1666V24.5C24.5 25.1443 23.9777 25.6666 23.3333 25.6666C22.689 25.6666 22.1667 25.1443 22.1667 24.5V22.1666C22.1667 21.2384 21.7979 20.3482 21.1415 19.6918C20.4852 19.0354 19.5949 18.6666 18.6667 18.6666H9.33333C8.40508 18.6666 7.51484 19.0354 6.85846 19.6918C6.20208 20.3482 5.83333 21.2384 5.83333 22.1666V24.5C5.83333 25.1443 5.311 25.6666 4.66667 25.6666C4.02233 25.6666 3.5 25.1443 3.5 24.5V22.1666C3.5 20.6195 4.11458 19.1358 5.20854 18.0419Z"
                          fill="white"
                        />
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M14.0003 4.66665C12.0673 4.66665 10.5003 6.23365 10.5003 8.16665C10.5003 10.0996 12.0673 11.6666 14.0003 11.6666C15.9333 11.6666 17.5003 10.0996 17.5003 8.16665C17.5003 6.23365 15.9333 4.66665 14.0003 4.66665ZM8.16699 8.16665C8.16699 4.94499 10.7787 2.33331 14.0003 2.33331C17.222 2.33331 19.8337 4.94499 19.8337 8.16665C19.8337 11.3883 17.222 14 14.0003 14C10.7787 14 8.16699 11.3883 8.16699 8.16665Z"
                          fill="white"
                        />
                      </svg>
                      <span>Profile</span>
                    ...
                    <i>
                      ...
                      >
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M20 3.63636C10.9626 3.63636 3.63636 10.9626 3.63636 20C3.63636 29.0374 10.9626 36.3636 20 36.3636C29.0374 36.3636 36.3636 29.0374 36.3636 20C36.3636 10.9626 29.0374 3.63636 20 3.63636ZM0 20C0 8.9543 8.9543 0 20 0C31.0457 0 40 8.9543 40 20C40 31.0457 31.0457 40 20 40C8.9543 40 0 31.0457 0 20ZM19.9998 10.9091C21.004 10.9091 21.818 11.7231 21.818 12.7273V18.1818H27.2728C28.277 18.1818 29.091 18.9958 29.091 20C29.091 21.0042 28.277 21.8182 27.2728 21.8182H21.818V27.2727C21.818 28.2769 21.004 29.0909 19.9998 29.0909C18.9957 29.0909 18.1816 28.2769 18.1816 27.2727V21.8182H12.7274C11.7232 21.8182 10.9092 21.0042 10.9092 20C10.9092 18.9958 11.7232 18.1818 12.7274 18.1818H18.1816V12.7273C18.1816 11.7231 18.9957 10.9091 19.9998 10.9091Z"
                          fill="white"
                        />
                      </svg>
                    </i>
          ...
          {/*COMPONENTS*/}
          <div className="flex flex-col gap-8 mx-72 mb-14 p-10 bg-blacky-200 text-white rounded-xl">
            <div>
            ...
            <div className="flex justify-center gap-10">
              ...
              <div className="flex flex-col gap-12">
                ...
                <SidebarButton 
                  user_name="Imeo"
                  img={mascotte}
                  handleClick={() => handleClick("Imeo")}
                />
                {/*chat input*/}
                <form
                  className="min-w-[960px] w-[100%] mt-1 flex items-center"
                >
                  <input
